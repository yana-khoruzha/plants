...
let burder = document.querySelector('.header__burger-btn');
...
document.addEventListener('click', function(event) {
    if(menu.classList.contains('active') && !(event.target.matches('.header__menu, .header__burger-btn, .header__menu *'))) {
        menu.classList.toggle('active');
        burder.classList.toggle('active');
    }
})
